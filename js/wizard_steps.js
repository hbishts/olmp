...
$(function () {
	...
	// Basic wizard setup
	$(".steps-basic#mobile-div, .steps-basic#aadhaar-div").steps({
		headerTag: "h6",
		bodyTag: "fieldset",
	...
	$(".steps-advanced#mobile-div, .steps-advanced#aadhaar-div").steps({
		headerTag: "h6",
		bodyTag: "fieldset",
		transitionEffect: "fade",
		titleTemplate: '<span class="number">#index#</span> #title#',
